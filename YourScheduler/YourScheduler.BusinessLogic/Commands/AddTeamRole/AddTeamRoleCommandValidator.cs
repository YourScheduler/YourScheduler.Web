...
{
    public class AddTeamRoleCommandValidator:AbstractValidator<AddTeamRoleCommand>
    {
        public AddTeamRoleCommandValidator(ITeamRoleRepository teamRoleRepository)
        {
